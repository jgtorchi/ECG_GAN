...
%     projectAndReshapeLayer(projectionSize,numLatentInputs,'proj');
%     concatenationLayer(3,2,'Name','cat');
%     transposedConv2dLayer([5 1],16*numFilters,'Name','tconv1')
%     batchNormalizationLayer('Name','bn1','Epsilon',5e-5)
%     reluLayer('Name','relu1')
%     transposedConv2dLayer([5 1],8*numFilters,'Stride',2,'Cropping',[0 0],'Name','tconv2')
%     batchNormalizationLayer('Name','bn2','Epsilon',5e-5)
%     reluLayer('Name','relu2')
%     transposedConv2dLayer([5 1],4*numFilters,'Stride',3,'Cropping',[0 0],'Name','tconv3')
%     batchNormalizationLayer('Name','bn3','Epsilon',5e-5)
%     reluLayer('Name','relu3')
%     transposedConv2dLayer([5 1],2*numFilters,'Stride',2,'Cropping',[0 0],'Name','tconv4')
%     batchNormalizationLayer('Name','bn4','Epsilon',5e-5)
%     reluLayer('Name','relu4')
%     transposedConv2dLayer([7 1],numFilters,'Stride',2,'Cropping',[0 0],'Name','tconv5')
%     batchNormalizationLayer('Name','bn5','Epsilon',5e-5)
%     reluLayer('Name','relu5')
%     transposedConv2dLayer([8 1],1,'Stride',2,'Cropping',[0 0],'Name','tconv6')
%     ];
...
%% save network
save('GAN12.mat','dlnetGenerator','dlnetDiscriminator', ...
